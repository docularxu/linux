...
/*
 * This header provides macros for SpacemiT K1 PDMA bindings.
 *
...
/*
 * Request type numbers for the SpacemiT K1 PDMA controller (DRQ).
 * These values represent the DMA request numbers for non-secure peripherals.
 */

...
static int ov5645_set_register_array(i2c_client_t *client,
...
static int ov5645_init(i2c_client_t *client)
{
...
static int ov5645_change_mode(i2c_client_t *client, enum ov5645_mode mode)
{
	struct reg_value *settings = NULL;
	s32 num_settings = 0;
	int ret = 0;
...
static int ov5645_set_aec_mode(i2c_client_t *client, int auto_mode)
{
	u8 val;
...
static int ov5645_set_awb(i2c_client_t *client, s32 enable_auto)
{
	u8 val;
